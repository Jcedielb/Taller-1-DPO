...
public class ConsolaOlimpicos
{
	...
	/**
	 * Ejecuta la opción para consultar el pais de un atleta.
	 */
	private void ejecutarPaisdelAtleta()
	{
		...
		String nombre_atleta = input("Ingrese el nombre del atleta que le interesa");
        String atletas = calculadora.buscarPaisAtleta(nombre_atleta);
        if (atletas == "null") {
        	System.out.println("No se encontró al atleta.");
        }else {
        	System.out.println("El pais del atleta es:"+ atletas);
        }
	}
